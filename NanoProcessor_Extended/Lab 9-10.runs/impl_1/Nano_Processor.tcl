...
set rc [catch {
  ...
  add_files -quiet {{E:/Github/NanoProcessor/Lab 9-10.runs/synth_1/Nano_Processor.dcp}}
...
set rc [catch {
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Nano_Processor_bus_skew_routed.rpt -pb Nano_Processor_bus_skew_routed.pb -rpx Nano_Processor_bus_skew_routed.rpx"
