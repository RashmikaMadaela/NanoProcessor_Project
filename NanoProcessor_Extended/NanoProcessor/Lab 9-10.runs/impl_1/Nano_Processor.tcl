...
set rc [catch {
  ...
  open_checkpoint Nano_Processor_routed.dcp
  set_property webtalk.parent_dir {E:/Github/NanoProcessor_Project/NanoProcessor_Extended/NanoProcessor/Lab 9-10.cache/wt} [current_project]
